        ...
        <nav className='sticky top-0 left-0 right-0 bg-black md:px-12 px-4 micro-5 md:text-3xl text-lg'>
            <div className="border-b border-white flex md:justify-center py-4 justify-between">
                <div className="md:w-1/2 w-auto h-16 flex items-center">
                    <img src="../_LevelUpAssessment/assets/logos/level-up-logo.webp" className="h-3/4 md:block hidden" alt="website nav logo" />
                    <img src="../_LevelUpAssessment/assets/logos/level-up-logo_mini.webp" className="h-3/4 md:hidden block" alt="website nav logo mobile"/>
                </div>
