        ...
        <tr className="border-2 border-t-white">
            ...
            <td className=" md:py-4 py-2 md:px-8 px-4 gap-4">
                <div className="flex justify-around">
                    <Link to={'../_LevelUpAssessment/customer/'+ props.graduateId} ><button className="inline rounded-full border-2 border-orange text-orange text-sm p-2 pl-4 pr-4 uppercase">View Mode</button></Link>
                    <Link to={'../_LevelUpAssessment/update/'+ props.graduateId} ><button className="inline rounded-full border-2 border-green text-green text-sm p-2 pl-4 pr-4 uppercase">Update</button></Link>
